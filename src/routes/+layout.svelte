...
<div class="navbar bg-base-100 px-4 md:px-8 py-5">
  <div class="navbar-start">
    <a href="/" class="flex items-center">
      ...
      <p class="font-bold text-xl md:text-2xl">SpoedSpecialist</p>
    </a>
  </div>
  <div class="navbar-end">
    ...
    <a href="/" class="btn border-black rounded-xl py-6 text-lg hidden lg:flex">
      <svg
    ...
    <div class="dropdown dropdown-end lg:hidden">
      ...
      >
        <li><a href="/" class="text-lg py-2">Abonnement</a></li>
        <li><a href="/" class="text-lg py-2">Blog</a></li>
        <li>
          <a
